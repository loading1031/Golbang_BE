...
from participants.socket import event_consumers, group_consumers, consumers
...
websocket_urlpatterns = [
    ...
    path('ws/participants/<int:participant_id>/', consumers.ParticipantConsumer.as_asgi()),
